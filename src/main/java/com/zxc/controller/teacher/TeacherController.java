...
public class TeacherController {
    ...
    public String updateCourseSuccess(@Param("content") String content,@Param("page") Integer page, Model model, HttpServletRequest request)throws UnsupportedEncodingException{
        String[] det= URLDecoder.decode(URLDecoder.decode(content,"utf-8"),"utf-8").split("\\|");
